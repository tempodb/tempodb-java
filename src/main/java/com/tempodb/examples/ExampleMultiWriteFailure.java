...
import com.tempodb.client.MultiPointStatus;
import com.tempodb.client.MultiStatusException;
import com.tempodb.models.MultiPoint;
import com.tempodb.models.MultiIdPoint;
import com.tempodb.models.MultiKeyPoint;


public class ExampleMultiWriteFailure {
    ...
    public static void main(String[] args) throws Exception {
        ...
        points.add(new MultiIdPoint("myagley-1", ts, 123.6));
        ...
        try {
          ...
          for(MultiPointStatus item : e) {
            System.out.print(item.getStatus() + " ");
            System.out.println(item.getMessages().toString());
          }
        }
    }
}
